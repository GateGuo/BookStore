            ...
            <form class="layui-form-pane layui-form" action="" method="post">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input class="layui-input" type="text" name="tName" id="tName">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">父类id</label>
                    <div class="layui-input-block">
                        <input class="layui-input" type="text" name="tParentId" id="tParentId">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">分类级别</label>
                    <div class="layui-input-block">
                        <input class="layui-input" type="text" name="tLevel" id="tLevel">
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
