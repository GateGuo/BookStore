            ...
            <form class="layui-form-pane layui-form" action="" method="post">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input class="layui-input" type="text" name="rUId" id="rUId">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">管理员id</label>
                    <div class="layui-input-block">
                        <input class="layui-input" type="text" name="rAId" id="rAId">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">消息</label>
                    <div class="layui-input-block">
                        <input class="layui-input" type="text" name="rMessage" id="rMessage">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">数据流向标记</label>
                    <div class="layui-input-block">
                        <input class="layui-input" type="text" name="rMark" id="rMark">
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
