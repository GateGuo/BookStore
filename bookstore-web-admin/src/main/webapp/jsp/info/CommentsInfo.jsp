    ...
    layui.use(['table','layer'], function(){
        ...
        table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'cId', title: '评论id',  sort: true, fixed: 'left'}
                ,{field: 'cBId', title: '商品id'}
                ,{field: 'cUId', title: '用户id'}
                ,{field: 'cParentId', title: '父评论id'}
                ,{field: 'cUTargetId', title: '回复目标id'}
                ,{field: 'cContent', title: '评论内容'}
                ,{field: 'cTime', title: '评论时间'}
