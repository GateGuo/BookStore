    ...
    layui.use(['table','layer'], function(){
        ...
        table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'obId', title: '二手书籍id',  sort: true, fixed: 'left'}
                ,{field: 'obName', title: '二手书名'}
                ,{field: 'obPrice', title: '二手书价格'}
                ,{field: 'obCount', title: '库存'}
                ,{field: 'obTag', title: '标签'}
                ,{field: 'obDescription', title: '描述'}
