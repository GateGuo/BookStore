    ...
    layui.use(['table','layer'], function(){
        ...
        table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'scId', title: 'id',  sort: true, fixed: 'left'}
                ,{field: 'scUId', title: '用户id'}
                ,{field: 'scBId', title: '商品id'}
                ,{field: 'scNumber', title: '商品数量'}
                ,{field: 'scCreateTime', title: '生成日期'}
                ,{field: 'scUpdatetimeTime', title: '更新日期'}
